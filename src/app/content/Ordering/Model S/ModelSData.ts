import tempestWheels19 from "../../../../common/assets/orders/common/wheels/ui_swat_whl_tempest.avif";
import arachnidWheels21 from "../../../../common/assets/orders/common/wheels/arachnid21.avif";
...
export const modelSData: modelDataType = [
    {
        ...
        wheels: [
            ...
            {
                type: "21’’ Arachnid Wheels",
                price: 4500,
                season: "All-Season Tires",
                range: "Range (est.) : 375mi",
                img: arachnidWheels21
            }
        ],
        color: [
            {
    ...
    },
    {
        ...
        characteristics: [
            ...
            {
                topText: "200", measurement: "mph", bottomText: "Top speed", color: "black"
            },
            {
                topText: "1.99", measurement: "sec", bottomText: "0-60 mph", color: "black"
            },
        ],
        wheels: [
            {
